      ...
      <section className="container pt-10 max-md:px-2 px-10">
        <div className="max-w-[805px] text-center mx-auto mb-10">
          ...
          <h6 className="sora-regular primary-text">
            Whether it’s adrenaline-pumping adventures or peaceful weekend
            escapes, we help you finance the tools of recreation:
          </h6>
        </div>
          ...
          <div className="text-center lg:text-left lg:ml-10">
            ...
            <div className="space-y-5 text-gray-800">
              ...
              <div>
                ...
                <p className="sora-regular primary-text">
                  Pick a plan that fits your lifestyle and budget.
                </p>
              </div>

              <div>
                <p className="sora-semibold">
              ...
              <div>
                ...
                <p className="sora-regular primary-text">
                  Transparent terms and affordable payments.
                </p>
              </div>
            </div>
          </div>
