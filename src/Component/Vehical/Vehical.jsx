...
import gooddog from '../../../public/assets/Images/Group-1171275242.png'
import backgroundimg from '../../../public/assets/Images/Background.png'
import HeroSection from '../HeroSection '
import img1 from '../../../public/assets/Images/v-1.png'
import img2 from '../../../public/assets/Images/v-2.png'
import img3 from '../../../public/assets/Images/v-3.png'
import img4 from '../../../public/assets/Images/v-4.png'
                    ...
                    <div className="text-center lg:text-left lg:ml-10">
                        ...
                        <div className="space-y-5 text-gray-800">
                            <div>
                                ...
                                <p className='sora-regular primary-text'>Select from a wide range of new or used vehicles.</p>
                            </div>

                            <div>
                                <p className="sora-semibold">Step 2: Apply Online</p>
                                <p className='sora-regular primary-text'>Fill out a quick, secure form. No impact on credit score.</p>
                            </div>

                            <div>
                                <p className="sora-semibold">Step 3: Get Approved Fast</p>
                                <p className='sora-regular primary-text' >Approval within hours – drive off the lot the same day.</p>
                            </div>
                        </div>
                    </div>
                </div>
