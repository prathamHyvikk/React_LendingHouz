...
import gooddog from "/assets/Images/Group-1171275242-1.png";
import backgroundimg from "/assets/Images/image.png";
import HeroSection from "../HeroSection ";
import img1 from "/assets/Images/t-1.png";
import img2 from "/assets/Images/t-2.png";
import img3 from "/assets/Images/t-3.png";
import img4 from "/assets/Images/t-4.png";
            ...
            <div className="space-y-5 text-gray-800">
              <div>
                ...
                <p className="sora-regular primary-text">
                  Select tires that fit your vehicle and budget.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="sora-regular primary-text">
                  Quick online application – no credit score required to check.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="sora-regular primary-text">
                  Get your tires installed right away, pay later
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
          {stats.map((item, index) => (
            ...
            >
              ...
              <p className="text-sm  primary-text sora-regular text-gray-600">
                {item.label}
              </p>
            </div>
          ))}
