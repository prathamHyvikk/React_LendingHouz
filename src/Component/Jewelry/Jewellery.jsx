  ...
  const steps = [
    {
      ...
      description:
        "Select your favorite pieces from our collection — no minimum purchase required.",
      icon: img1,
      bgColor: "#E6F0FA",
    },
    {
      ...
      description:
        "Spread your payments over 3, 6, or 12 months with 0% interest* or low monthly installments.",
      icon: img2,
      bgColor: "#FEF4E6",
    },
    {
      ...
      description:
        "Fast, secure approval with no hidden fees and no credit score impact.",
      icon: img3,
      bgColor: "#E6F0FA",
    },
    {
  ...
  return (
    <>
      ...
      <section className="max-md:px-2   px-10">
        <HowItWorks
          steps={steps}
          maintitle="How Jewellery Financing Works"
          bgColor="bg-gray-100"
        />
      </section>
