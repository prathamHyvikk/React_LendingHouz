...
import ringimg from "/assets/Images/Group-1171275223.png";
import section3img from "/assets/Images/Group-1171275225.png";
  ...
  return (
    <>
        ...
        <div className="w-full rounded-lg flex flex-col gap-10 lg:flex-row items-center">
          ...
          <div className="flex flex-col gap-4 lg:ml-10">
            <h1 className="text-4xl sora-regular text-gray-800">
              Finance the Gear to Create the Music You Love
            </h1>
            <h6 className="sora-regular primary-text ">
              From guitars and keyboards to studio mixers and DJ equipment, we
              offer fast, affordable financing options so you can:
            </h6>
            <ul className="mt-4  ">
      ...
      <section className="container max-md:px-2 px-10">
        <h1 className="text-3xl sora-regular text-center mb-10">
      ...
      <div className="container max-md:px-2 px-10">
        <div className="flex flex-col gap-2 items-center text-center">
          ...
          <h6 className="sora-regular max-md:leading-7 primary-text max-w-[630px]">
