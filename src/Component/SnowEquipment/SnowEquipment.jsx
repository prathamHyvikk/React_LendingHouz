  ...
  const steps = [
    {
      ...
      description:
        "Shop from a wide range of phones, laptops, tablets, TVs, gaming consoles & more.",
      icon: img1,
      bgColor: "#E6F0FA",
    },
    {
      ...
      description:
        "Our fast, hassle-free application process gets you approved in just a few clicks.",
      icon: img2,
      bgColor: "#FEF4E6",
    },
    {
      ...
      description:
        "We work with all credit types including no credit or bad credit.",
      icon: img3,
      bgColor: "#E6F0FA",
    },
    {
      title: "Pay Over Time",
      description:
        "Pick a plan that works for your budget. No hidden fees. No surprises.",
      icon: img4,
      bgColor: "#F0E6FA",
    },
  ];
  ...
  return (
    <>
      ...
      <div className=" container py-10 px-4 text-center">
        <h1 className="sora-regular max-w-[1072px] max-lg:leading-10 mx-auto text-center text-gray-900 mb-8">
        ...
        <div className=" grid sm:grid-cols-2 lg:grid-cols-3 grid-cols-1 justify-between gap-4">
          {items.map((item, index) => (
            ...
            >
              ...
              <p className="text-sm sora-semibold max-sm:text-start text-black">
                {item.title}
              </p>
            </div>
          ))}
      ...
      <section className=" container py-12 gap-5  flex flex-col  items-center  justify-between p-4">
        <h1 className="sora-regular leading-10 text-center mb-4 max-md:leading-10">
          Conquer Winter with Affordable Snow Equipment Financing
        </h1>
        <div className="w-full rounded-lg flex flex-col gap-10 lg:flex-row items-center">
          <div className="flex flex-col lg:ml-10">
            <h6
              style={{ wordSpacing: "0.5rem" }}
              className="text-4xl  sora-regular mb-4 text-gray-800"
            >
              Don’t let upfront costs freeze your progress. Harsh winters demand
              reliable equipment—and we make it easier than ever to get it. With
              our specialized snow equipment financing, you can invest in the
              plows, snow blowers, salt spreaders, and heavy-duty trucks you
              need without a large upfront payment. Whether you're preparing for
              a busy season or replacing outdated gear, our financing solutions
              are designed to keep your operations running smoothly and your
              cash flow intact. From solo contractors to large snow removal
              companies, we serve businesses of all sizes with fast approvals,
              customizable payment plans, and no impact on your credit just to
              explore options.
            </h6>
            <BtnGetStart />
          </div>
