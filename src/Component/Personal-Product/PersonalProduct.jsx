...
import gooddog from '../../../public/assets/Images/pngtree-smile-phone-and-video-call-with-a-business-woman-in-studio-png-image_13175806 2.png'
import backgroundimg from '../../../public/assets/Images/Group-1171275275.png'
import HeroSection from '../HeroSection '
import section1img from '../../../public/assets/Images/Frame-1707481313.png'
import img1 from '../../../public/assets/Images/Tools-5.png'
import img2 from '../../../public/assets/Images/tool-1.png'
import img3 from '../../../public/assets/Images/tool-3.png'
import img4 from '../../../public/assets/Images/tool-4.png'
    ...
    return (
        <>
            ...
            <div className="container max-md:px-2 px-10   py-10 ">
                <h1 className="sora-regular   leading-10 text-center ">Smart Financing for the Products You Love</h1>
                <h6 className='sora-regular mb-10 text-center  mt-5 ' >From everyday essentials to lifestyle upgrades, get the personal products you want—without financial stress. Our flexible financing options let you buy now and pay later, with fast approvals and no credit impact to check eligibility.</h6>
            ...
            <section className="  max-md:px-2 px-10  pt-10 rounded-2xl pb-10">
                <div className=" container grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div className="text-center lg:text-left ">
                        <h1 className="  sora-regular leading-10 mb-6">What is Personal Product Financing?</h1>
                        <p className='sora-regular'>Whether it’s a phone upgrade, home gym, beauty tool, or new appliance—you shouldn’t have to delay the things that improve your life. With our personal product financing, you can buy now, pay over time without breaking your budget. </p>
                    </div>
                    <img
                        src={backgroundimg}
