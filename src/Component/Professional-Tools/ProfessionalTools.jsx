...
import gooddog from "/assets/Images/pngwing.com-(31)-10.png";
  ...
  return (
    <>
      ...
      <div className="py-16 px-2 container text-center bg-white">
        <h1 className=" sora-regular sora-bold mb-12">
          ...
          {stats.map((item, index) => (
            <div key={index} className="relative h-fit">
              ...
              <div className="relative  z-10 bg-white rounded-xl shadow-md px-6 py-8">
                ...
                <p className="text-sm  sora-regular text-gray-800 mt-2">
                  {item.label}
                </p>
              </div>
            </div>
          ...
          {services.map((item, index) => (
            <div key={index} className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm sora-regular text-gray-600">
                  {item.desc}
                </p>
              </div>
            </div>
