    ...
    <>
      ...
      <section className='container max-md:px-2 py-10 px-10' >
        <div className='max-w-[619px] flex mx-auto items-center mb-4 gap-4 flex-col text-center'>
          ...
          <h6 className='sora-regular primary-text'>We make car financing simple, fast, and accessible for everyone. No matter your credit score, we connect you with trusted lenders and flexible options. Enjoy transparent terms, competitive rates, and expert support from start to finish.</h6>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <h6 className="primary-text sora-regular mb-10 max-w-md">
              Apply online in minutes, get pre approved instantly with no credit impact. Choose your car, sign the paperwork, and drive away — it’s that easy!
            </h6>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-gray-100 p-5 rounded-xl transition-all duration-300 hover:bg-black hover:text-white cursor-pointer">
                ...
                <p className="text-sm primary-text sora-semibold">Takes less than 3 minutes</p>
              </div>
              ...
              <div className="bg-gray-100 p-5 rounded-xl transition-all duration-300 hover:bg-black hover:text-white cursor-pointer">
                ...
                <p className="text-sm primary-text sora-semibold">Instantly, with no impact on credit</p>
              </div>
              ...
              <div className="bg-gray-100 p-5 rounded-xl transition-all duration-300 hover:bg-black hover:text-white cursor-pointer">
                ...
                <p className="text-sm primary-text sora-semibold">From partnered dealers or private sellers</p>
              </div>
              ...
              <div className="bg-gray-100 p-5 rounded-xl transition-all duration-300 hover:bg-black hover:text-white cursor-pointer">
                ...
                <p className="text-sm primary-text sora-semibold">Stress free paperwork & fast closing</p>
              </div>
            </div>
