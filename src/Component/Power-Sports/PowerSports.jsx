  ...
  return (
    <>
      ...
      <section className="max-md:px-2 py-10 px-10">
        <HowItWorks
          steps={steps}
          maintitle="Who We Help"
          bgColor="bg-gray-100"
        />
      </section>

      <section className="container py-4 max-md:px-2 px-10">
        <h1 className=" sora-regular leading-10  text-center mb-10">
          Vehicles We Help You Own
        </h1>
      ...
      <section className="container py-10 max-md:px-2 px-10">
        <h1 className=" text-center leading-10 sora-regular">
          Our Impact in Numbers
        </h1>
        <h6 className="primary-text text-center mt-2 max-lg:mt-10 mb-10">
          Trusted by thousands of riders nationwide.
        </h6>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 justify-items-center">
          <div className="flex flex-col items-center text-center">
            ...
            <h6 className="mt-4 sora-medium text-gray-700">
              800+ Vehicles Financed
            </h6>
          </div>
