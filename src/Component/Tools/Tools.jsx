  ...
  const steps = [
    {
      ...
      description:
        "Apply in minutes and get approved quickly—often the same day.",
      icon: img1,
      bgColor: "#E6F0FA",
    },
    {
      ...
      <section className=" p-6 md:p-12 py-10 rounded-2xl">
        <div className=" container grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="text-center lg:text-left ">
            <h1 className="  sora-regular leading-10 mb-4">
              Why Finance with Us?
            </h1>
            <h6 className="sora-regular primary-text">
              {" "}
              Don’t let your growth be limited by your budget
            </h6>
            <p className="sora-regular">
              Whether you’re a contractor, mechanic, woodworker, or
              tradesperson, our financing solutions help you invest in the tools
              you need—right when you need them. Upgrade or expand your toolkit
