            ...
            <Link to="/blog-detail">
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-lg h-12 line-clamp-2 sora-semibold group-hover:text-[#FF9201]   text-gray-900 leading-snug mb-3">
                    {post.title}
                  </h3>

                  <p className="text-gray-600 h-11 line-clamp-2  sora-regular text-sm mb-4">
                    {post.desc}
                  </p>

                  <div className="text-sm font-semibold text-black hover:underline inline-flex items-center">
                    Read More →
                  </div>
                </div>
              </div>
