  ...
  const steps = [
    {
      ...
      description:
        "Choose a puppy from one of our trusted breeders or shelters.",
      icon: img1,
      bgColor: "#E6F0FA",
    },
    {
      ...
      description:
        "Our simple application takes less than 5 minutes. Instant decisions available.",
      icon: img2,
      bgColor: "#FEF4E6",
    },
    {
      ...
      description:
        "We offer flexible financing options for all credit types even first time pet owners.",
      icon: img3,
      bgColor: "#E6F0FA",
    },
    {
      title: "Pay Over Time",
      description:
        "Pick up your pup or arrange delivery. Your journey together starts today.",
      icon: img4,
      bgColor: "#F0E6FA",
    },
  ];
      ...
      <div className="bg-white max-md:px-2 px-10 py-12">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h1 className="text-4xl   sora-regular text-gray-900 mb-4">
              Why Choose Us?
            </h1>
            <h6 className="text-lg text-blue-600 mb-8">
              We’re more than just a financing option we’re your trusted partner
              in bringing home a healthy, happy dog. Our mission is to make pet
              ownership accessible, ethical, and stress free from day one.
            </h6>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              ...
              >
                <p className="text-3xl sora-bold text-gray-900 mb-2">
                  {stat.value}
                </p>
