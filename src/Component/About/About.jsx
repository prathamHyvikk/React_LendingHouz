...
import tractore from '../../../public/assets/Images/about-img.png'
import tractore2 from '../../../public/assets/Images/Group-1171275285-about.png'
    ...
    return (
        <>
            ...
            <section className="flex flex-col max-md:px-2 px-10 md:py-10 container items-center justify-between py-4    ">
                ...
                <h1 className=" sora-regular text-start w-full lg:text-center text-gray-900 mb-10">Who We Serve</h1>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start">
                                ...
                                <div className='flex flex-col' >
                                    <h6 className="primary-text sora-semibold">Farmers & Ranchers</h6>
                            ...
                            <li className="flex items-start">
                                ...
                                <div className='flex flex-col' >
                                    <span className="primary-text sora-semibold">Landscapers & Contractors</span>
                                    <p className='sora-regular' >financing work tools and vehicles</p>
                                </div>
                            ...
                            <li className="flex items-start">
                                ...
                                <div className='flex flex-col' >
                                    <span className="primary-text sora-semibold">Families & Individuals</span>
                                    <p className='sora-regular' >financing furniture, electronics, and personal items</p>
                                </div>
                            ...
                            <li className="flex items-start">
                                ...
                                <div className='flex flex-col' >
                                    <span className="primary-text sora-semibold">Small Businesses</span>
                                    <p className='sora-regular' >managing startup costs or upgrades</p>
                                </div>
            ...
            <section className="flex flex-col max-md:px-2 px-10 md:py-10 py-4 container items-center justify-between    ">
                ...
                <div className="flex flex-row max-lg:flex-col items-center justify-between gap-10  w-full">
                    ...
                    <div className="lg:w-1/2 md:pl-6 w-full flex flex-col items-start">
                        <h1 className=" sora-regular md:text-4xl text-2xl  text-gray-900 mb-10">What Makes Us Different?</h1>
                        <ul className="space-y-4">
                            <li className="flex  items-start">
                                <svg
                                    className="w-5 h-5 flex justify-center items-center mr-2"
                                ...
                                <div className='flex flex-wrap items-center gap-2 ' >
                                    <span className="primary-text sora-semibold">Fast, Easy Applications –</span>
                            ...
                            <li className="flex items-start">
                                ...
                                <div className='flex flex-wrap items-center gap-2 ' >
                                    <span className="primary-text sora-semibold">Fair & Flexible Terms –</span>
                            ...
                            <li className="flex items-start">
                                ...
                                <div className='flex flex-wrap items-center gap-2 ' >
                                    <span className="primary-text sora-semibold">Friendly Support –  </span>
                                    <p className='sora-regular' >Real people helping real people</p>
                                </div>
                            ...
                            <li className="flex items-start">
                                ...
                                <div className='flex flex-wrap items-center gap-2 ' >
                                    <span className="primary-text sora-semibold">Transparent Process – </span>
