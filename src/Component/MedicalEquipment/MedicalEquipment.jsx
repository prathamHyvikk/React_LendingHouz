  ...
  return (
    <>
      ...
      <div className=" container py-10  max-md:px-2 px-10 text-center">
        <h1 className="sora-regular leading-10 max-w-[1072px] mx-auto max-md:leading-10 text-center text-gray-900 mb-8">
        ...
        <div className="flex flex-col md:flex-row justify-around md:items-start text-center  mx-auto space-y-6 md:space-y-0 md:space-x-6">
          <div className="flex flex-col gap-2 items-center">
            ...
            <p className="text-2xl sora-semibold leading-7 text-gray-900">
              Healthcare Providers Financed
            </p>
            <p className="  sora-regular  text-gray-900">
              Partnered with 1200+ trusted doctors for expert care.
            </p>
          </div>
          <div className="flex flex-col gap-2 items-center">
            <h2 className="primary-text sora-medium text-[48px]">$50+</h2>
            <p className="text-2xl sora-semibold leading-7 text-gray-900">
              Million in Equipment Financed
            </p>
            <p className="  sora-regular  text-gray-900">
              Access to essential tools without straining budgets.
            </p>
          </div>
          <div className="flex flex-col gap-2 items-center">
            ...
            <p className="  sora-regular  text-gray-900">
              We work hard to say "yes" — even when others don’t.
            </p>
          </div>
        </div>
      </div>
      ...
      <section className=" container pb-10 max-md:px-2 px-10 flex items-center justify-between p-4">
        <div className="w-full rounded-lg flex flex-col gap-10 lg:flex-row items-center">
          <div className="flex flex-col lg:ml-10 max-md:items-center">
            <h1 className="text-4xl sora-regular max-md:text-center text-gray-800">
              Finance a Wide Range of Medical Equipment
            </h1>
          ...
          <img src={section3img} alt="Laptop with Headphones" />
        </div>
      </section>
